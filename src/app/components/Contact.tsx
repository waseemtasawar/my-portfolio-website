...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const response = await fetch('https://formspree.io/f/xpwqwqel', {
      method: 'POST',
      headers: {
  ...
  return (
    <section id='contact' className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-gray-100 via-gray-200 to-gray-300 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-6">
